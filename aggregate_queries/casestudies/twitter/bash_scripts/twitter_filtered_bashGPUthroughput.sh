...
cd ../../../../private_queries/
FILE_NAME="../../aggregate_queries/casestudies/twitter/bash_scripts/ResGPUThroughput_$FILE.txt"
...
do
    ...
    for ((v =0; v<$T_MAX; v+=1));
    do				
        ./barrett ../../aggregate_queries/casestudies/twitter/ccs_files/val.22 ../../aggregate_queries/casestudies/twitter/ccs_files/out_$FILE.row ../../aggregate_queries/casestudies/twitter/ccs_files/out_$FILE.col >> $FILE_NAME	
    done
    cd ..
done
cd ../aggregate_queries/casestudies/twitter/bash_scripts/
