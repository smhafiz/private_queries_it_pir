...
prefix='../../private_queries/'
files = [prefix+'out_2.col', prefix+'out_4.col', prefix+'out_8.col', prefix+'out_16.col', prefix+'out_32.col', prefix+'out_64.col', prefix+'out_128.col', prefix+'out_256.col', prefix+'out_512.col', prefix+'out_1024.col']
